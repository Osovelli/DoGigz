...
function CourseCard({ course }) {
  return (
    <div className="flex flex-col md:flex-row gap-6 p-4 hover:bg-gray-50 rounded-lg transition-colors">
      {/* Thumbnail */}
      <img
        ...
        <div className="space-y-3">
          ...
          {course.status === "ongoing" ? (
            <div className="space-y-1">
              <Progress value={course.progress}  className="h-2 max-w-md shadow-sm border" />
