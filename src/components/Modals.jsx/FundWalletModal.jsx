...
import CardFundingModal from "./CardFundingModal"
...
function FundWalletModal({ isOpen, onClose}) {
  ...
  const handleMethodSelect = (methodId) => {
    ...
    if (methodId === "other") {
      setShowBankDetails(false)
      // Handle other payment logic here
    }
  }
      ...
      <div className="p-6">
        ...
        <div className="space-y-3">
          {paymentMethods.map((method) => (
            ...
            >
              <div className="h-10 w-10 bg-basic text-gray-800 rounded-full flex items-center justify-center">
                {method.icon}
              </div>
              <div>
